...
ADV_OPERATORS = {"^":math.pow, 'srt':math.sqrt, 'cos':math.cos, 'sin':math.sin, "tan":math.tan, "log":math.log, "epow":math.exp, "tlog":math.log10, "!":math.factorial, "rm":sysfuncs.delete_stack, "nlog":math.log,"ra":math.radians, "deg":math.degrees, "crt":mathfuncs.cube_root, 'help':sysfuncs.help, 'man':sysfuncs.help,";":sysfuncs.clear_line}
MATHS_CONSTANTS = {"pi":math.pi, "eu":math.e}

operation_single = ["srt", "cos", "sin", "tan", "epow", "tlog", "!", "nlog", "ra", "deg", "crt"]
operation_double = ["^", "log"]
